...
func TestCCVTestSuite(t *testing.T) {
	...
	ccvSuite := e2e.NewCCVTestSuite[*oraiApp.OraichainApp, *appConsumer.App](
		// Pass in OraiAppIniter for provider and icstestingutils.ConsumerAppIniter consumer.
		OraiAppIniter, icstestingutils.ConsumerAppIniter,
		[]string{
			"TestStopConsumerChain", "TestStopConsumerOnChannelClosed", "TestProviderChannelClosed",
		})
